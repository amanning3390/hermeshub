/**
 * Run the payments migration against Neon Postgres
 * Each statement run separately in order
 */
import { neon } from "@neondatabase/serverless";

const DATABASE_URL = process.env.DATABASE_URL || "postgresql://neondb_owner:npg_fJvOC7l2coNm@ep-orange-bread-addenb6p-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require";
...
async function run() {
  console.log("Starting HermesHub payments migration...\n");
