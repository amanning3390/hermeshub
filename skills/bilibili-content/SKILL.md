...
description: "Use when the user shares a Bilibili link, wants a video summarized, or needs transcripts/study notes. Extract subtitles (AI + uploader + ASR fallback) and top comments. 当用户分享B站链接、需要视频总结或学习笔记时使用。提取字幕（AI生成+投稿者上传+ASR兜底）和热门评论。"
version: 1.0.0
