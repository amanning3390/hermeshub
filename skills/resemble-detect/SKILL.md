...
description: Deepfake detection and media safety for Hermes Agent. Detect AI-generated audio, images, video, and text, trace synthesis sources, apply invisible watermarks, verify speaker identity, and extract media intelligence using the Resemble AI detection platform.
version: "1.0.0"
license: Apache-2.0
...
metadata:
  ...
  repository: https://github.com/resemble-ai/detect-skill
  hermes:
    tags: [detection, deepfake, media-forensics, audio, video, image, text, watermarking, source-tracing, speaker-verification, provenance, safety]
    category: detection
    requires_tools: []
prerequisites:
