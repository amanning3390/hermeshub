...
version: "0.8.0"
license: MIT
compatibility: Requires GEMINI_API_KEY (Google Gemini API). Python packages google-genai and Pillow required.
metadata:
  author: fang-lin
  repo: https://github.com/fang-lin/consistent-portrait-set
  hermes:
    tags: [image-generation, portraits, photos, gemini, face-locking, consistency]
    category: creative
